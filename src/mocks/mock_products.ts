...
export const products: SupabaseProduct[] = [
  {
    ...
    content:
      "Full access to our premium news channel with live updates, expert analysis, and exclusive reports",
    period: 1,
  },
  {
    id: 2,
    ...
    content:
      "Detailed market analysis, trading strategies, and real-time stock recommendations",
    period: 1,
  },
  {
    id: 3,
    ...
    content:
      "Access to exclusive trading signals, market analysis, and community discussions",
    period: 3,
  },
  {
    id: 4,
    ...
    content:
      "Professional forex trading signals with entry points, stop loss, and take profit levels",
    period: 2,
  },
  {
    id: 5,
    ...
    content:
      "Full library of investment courses, tutorials, and expert webinars",
    period: 6,
  },
];
